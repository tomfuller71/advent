...
def main(data, log=False):
    ...
    for i, game in enumerate(games):
        ...
        part_1 += i + 1 if valid_game else 0
        part_2 += math.prod(mins.values())
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--infile", type=str, default="input.txt", help="The data infile to use"
    )
